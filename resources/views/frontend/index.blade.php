	...
	<section class="section-slide">
		<div class="wrap-slick1">
			<div class="slick1">
				...
				<div class="item-slick1" style="background-image: url({{asset('cozastore')}}/images/slide-02.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
				...
				<div class="item-slick1" style="background-image: url({{asset('cozastore')}}/images/slide-03.jpg);">
					<div class="container h-full">
						<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
...
<!-- 					<div class="block1 wrap-pic-w">
						<img src="{{asset('cozastore')}}/images/banner-01.jpg" alt="IMG-BANNER">
 ...
 -->					<!-- Block1 -->
<!-- 					<div class="block1 wrap-pic-w">
						<img src="{{asset('cozastore')}}/images/banner-02.jpg" alt="IMG-BANNER">
 ...
 -->					<!-- Block1 -->
	<!-- 				<div class="block1 wrap-pic-w">
						<img src="{{asset('cozastore')}}/images/banner-03.jpg" alt="IMG-BANNER">
	...
	<section class="bg0 p-t-23 p-b-140">
		<div class="container">
			...
			<div class="flex-c-m flex-w w-full p-t-45">
				...
				<a href="#" class="flex-c-m stext-101 cl5 size-103 bg2 bor1 hov-btn1 p-lr-15 trans-04" id="loadmore">
					Load More
				</a>
			</div>
		</div>
								...
								<div class="slick3 gallery-lb">
									<div class="item-slick3" data-thumb="{{asset('cozastore')}}/images/product-detail-01.jpg">
										<div class="wrap-pic-w pos-relative">
											...
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{asset('cozastore')}}/images/product-detail-01.jpg">
									...
									<div class="item-slick3" data-thumb="{{asset('cozastore')}}/images/product-detail-02.jpg">
										<div class="wrap-pic-w pos-relative">
											...
											<a class="flex-c-m size-108 how-pos1 bor0 fs-16 cl10 bg0 hov-btn3 trans-04" href="{{asset('cozastore')}}/images/product-detail-02.jpg">
												<i class="fa fa-expand"></i>
											</a>
										</div>
									</div>
